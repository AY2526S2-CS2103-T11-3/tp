...
* Veon: AI tools (Claude) were used to assist in development, bug finding and test creation. These tools were used to locate parts of addressbook to change to clinicbook and points to change when a feature is to be implemented.
